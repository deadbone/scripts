...
#RUN_AS=sickbeard                                    # User that runs the script
RUN_AS=Thierry
AGE=${2}                                            # set age in days of video files to look subs for
lang1=fr                                            # set first language (ISO 639-1)
lang2=en                                            # second language (leave blank if not needed) (ISO 639-1)

PATH_TO_TV=${1}                                     # Directory/file to process
PLUGINS='-s opensubtitles -s addic7ed'                              # Set your plugins or leave empty to use all
